...
public class ReadingZipFilesTest {
    public void readPdfFromZip2(ZipInputStream zipInputStream) throws Exception {
    ...
    public void readExcelFromZip2(ZipInputStream zipInputStream) throws Exception {
    ...
    public void readCsvFromZip2(ZipInputStream zipInputStream) throws Exception {
